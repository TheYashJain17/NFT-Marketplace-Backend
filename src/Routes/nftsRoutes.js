...
const authentication = require('../../Controllers/authenticationAllData');
...
.get(authentication.protectData , nftAPIsData.getSingleNft) //after defining the router we have defined our route to get single nft by providing the data of the API which we have imported.
